...
async function initializeDatabase() {
  ...
  try {
    ...
    console.log(`Created ${companyResults.insertedCount} companies and ${users.length} users.`);
    console.log('\nDemo credentials:');
    console.log('Company: contact@secureinsurance.example / company123');
    console.log('Admin: admin@insurance-ai.example / admin123');
