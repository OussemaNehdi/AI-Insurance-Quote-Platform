      ...
      setChatHistory([
        {
          ...
          Always respond with the JSON structure containing:
          - "answer": your conversational response 
          - "collectedData": object with any collected info

          Once you have all 4 pieces of information (age, country, gender, city), set "completed": true in collectedData.

          The user has selected ${selectedInsuranceType} insurance. Start by asking for their age in a friendly way.`
        }
      ]);
